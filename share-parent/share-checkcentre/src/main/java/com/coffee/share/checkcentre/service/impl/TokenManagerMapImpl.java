...
public class TokenManagerMapImpl implements TokenManagerService {
     ...
     * (non-Javadoc)
     * 
     * @see com.coffee.share.checkcentre.service.TokenManagerService#validata(java.
     * lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.coffee.share.checkcentre.service.TokenManagerService#addToken(java.
     ...
     * (non-Javadoc)
     * 
     * @see com.coffee.share.checkcentre.service.TokenManagerService#invalid(java.
     * lang.String)
     */
    @Override
